...
public class QueryServiceImpl implements QueryService{
     ...
     */
    @Override
    public List<Movie> makeTermQuery(String indexName, JSONObject typeJSON) throws JSONException {
        ...
        try {
            ...
            SearchResponse<Movie> response = elasticsearchClient.search(s -> s.index(indexName).query(tq._toQuery())
                    .size(10), Movie.class);
     ...
     */
    @Override
    public List<Movie> makeTermsQuery(String indexName, JSONObject typeJSON) throws JSONException {
        // NOT WORKING
    ...
    public List<Movie> performQuery(Query finalQuery) {
        try {
            SearchResponse<Movie> response = elasticsearchClient.search(s -> s.index(IMDB_INDEX).query(finalQuery)
